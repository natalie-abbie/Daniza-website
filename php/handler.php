...
} else {$errors[] = 'You forgot to enter your Full Name.';}
...
mail("info@danizatours.co.ug", "BOOKINGS ENQUIRY", $message, $headers);
echo "Your mail has been sent successfuly ! Thank you. We shall get back to you soon";
}
}
}
?>
